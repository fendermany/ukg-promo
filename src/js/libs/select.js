...
import {_slideToggle, _slideUp, FLS,} from "../files/functions.js";
import {updateResults} from "../files/script.js";
...
class SelectConstructor {
  ...
  setSelectChange(originalSelect) {
    ...
    if (originalSelect.hasAttribute("data-calc") && originalSelect.value) {
      updateResults();
    }
